//create the vin db
create or replace database vin;

//drop the public schema
drop schema public;

//create decode schema
create or replace schema decode;

/*next up is a bunch of code from the training*/
...
/*VIN Structure:
WMI (3 char) - world manufacturere indentifier
VDS (5 char) - vehicle descriptor section
# (1 char) - a number
MYC (1 char) - model year code
PC (1 char) - plant code
ALSN (6 char) - assembly line sequence number
*/

--create a variable and set the value
set sample_vin = 'SAJAJ4FX8LCP55916';

--check to make sure you set the variable above (notice $ when using var)
select $sample_vin;
